...
Mod_AddonSkins.font = C["media"].dantell
Mod_AddonSkins.smallFont = C["media"].coldasice
Mod_AddonSkins.fontSize = 22
Mod_AddonSkins.fontFlags = "OUTLINEMONOCHROME"
Mod_AddonSkins.buttonSize = 13
