...
ns.Filger_Spells = {
	...
	["MAGE"] = {
			...
			Opacity = 1,
			Mode = "ICON",
			setPoint = { "RIGHT", UIParent, "CENTER", -195, -115 },

			-- Time Warp 
--			{ spellID = 80353, size = 39, unitId = "player", caster = "player", filter = "BUFF" },
			-- Icy Veins
--			{ spellID = 12472, size = 39, unitId = "player", caster = "player", filter = "BUFF" },
			-- Fingers of Frost
			...
			-- Arcane Missiles!
			{ spellID = 79683, size = 39, unitId = "player", caster = "player", filter = "BUFF" },
			-- Arcane Power
			{ spellID = 12042, size = 39, unitId = "player", caster = "player", filter = "BUFF" },
			-- Blazing Speed
			{ spellID = 31643, size = 39, unitId = "player", caster = "player", filter = "BUFF" },
			-- Ice Barrier
--			{ spellID = 11426, size = 39, barWidth = 186, unitId = "player", caster = "player", filter = "BUFF" },
			-- Mana Shield
--			{ spellID = 1463, size = 39, barWidth = 186, unitId = "player", caster = "player", filter = "BUFF" },
			-- Mage Ward
--			{ spellID = 543, size = 39, barWidth = 186, unitId = "player", caster = "player", filter = "BUFF" },
		},
		{
			Name = "P_PROC_ICON",
			Direction = "LEFT",
			Interval = 2.6,
			Mode = "ICON",
			setPoint = { "TOP", TukuiPlayer, "RIGHT", -18, 93 },
...
--			{ spellID = 12358, size = 39, unitId = "player", caster = "player", filter = "BUFF" },
			...
			-- Ice Barrier
			{ spellID = 11426, size = 26, barWidth = 186, unitId = "player", caster = "player", filter = "BUFF" },
			-- Mana Shield
			{ spellID = 1463, size = 26, barWidth = 186, unitId = "player", caster = "player", filter = "BUFF" },
			-- Mage Ward
			{ spellID = 543, size = 26, barWidth = 186, unitId = "player", caster = "player", filter = "BUFF" },
			-- Slow Fall
			{ spellID = 130, size = 26, barWidth = 186, unitId = "player", caster = "player", filter = "BUFF" },
			-- Nitro Boots
			{ spellID = 54861, size = 26, barWidth = 186, unitId = "player", caster = "player", filter = "BUFF" },
			-- Clearcasting
			{ spellID = 12536, size = 26, unitId = "player", caster = "player", filter = "BUFF" },
		},
		{
			Name = "T_DEBUFF_ICON",
			Direction = "RIGHT",
			Interval = 4,
			Mode = "ICON",
			setPoint = { "LEFT", UIParent, "CENTER", 195, -115 },
			...
			-- Dragon's Breath
			{ spellID = 31661, size = 39, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Blast Wave
			{ spellID = 11113, size = 39, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Frost Nova
			{ spellID = 122, size = 39, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Living Bomb
			...
			-- Freeze!
			{ spellID = 33395, size = 39, unitId = "target", caster = "pet", filter = "DEBUFF" },
			-- Deep Freeze
			{ spellID = 44572, size = 39, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Ring of Frost
			{ spellID = 82691, size = 39, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Improved Cone of Cold
			{ spellID = 83302, size = 39, unitId = "target", caster = "player", filter = "DEBUFF" },
			-- Improved Counterspell
			{ spellID = 55021, size = 39, unitId = "target", caster = "player", filter = "DEBUFF" },
		},
		{
			Name = "F/DEBUFF_BAR",
			Direction = "UP",
	...
	["PRIEST"] = {
		...
		-- },
		{
			...
			-- Surge of Light
			{ spellID = 33151, size = 39, unitId = "player", caster = "all", filter = "BUFF" },
			-- Serendipity
