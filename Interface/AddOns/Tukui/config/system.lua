...
T.Fonts = {
	...
	-- map
	mTitle = Font(caith, 22, "MONOCHROMEOUTLINE", nil, nil, nil), -- region name
	mGeneral = Font(caith, 22, "MONOCHROMEOUTLINE", nil, nil, nil), -- show quest/digsite
	mArea = Font(caith, 22*3, "MONOCHROMEOUTLINE", nil, nil, nil), -- hover over
	
	-- nameplates
	nGeneral = Font(pixel, 10, "MONOCHROMEOUTLINE", nil, nil, nil),
	
	-- tooltip
	tGeneral = Font(pixel, 13, "MONOCHROMEOUTLINE", nil, nil, nil, nil),
...
T.Colors = {
	...
	reaction = {
		...
		[5] = { 0/255, 222/255, 0/255 }, -- Friendly
