...
C["media"] = {
	...
	["coldasice"] = [[Interface\AddOns\Tukui\media\fonts\coldasice.ttf]], -- coldasice
	["dantell"] = [[Interface\AddOns\Tukui\media\fonts\dantell.ttf]], -- dantell
	...
	-- colors
	["bordercolor"] = { .07, .07, .07 }, -- border color of tukui panels
	["backdropcolor"] = { 0, 0, 0, 1 }, -- background color of tukui panels
	["altbordercolor"] = { .07, .07, .07 }, -- alternative border color, mainly for unitframes text panels.
