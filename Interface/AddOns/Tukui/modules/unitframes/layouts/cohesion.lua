...
--			self.Combat = Combat
		...
		if T.myclass == "ROGUE" and C["unitframes"].rogue then
			...
			CPoints[1]:SetStatusBarColor(255, 0, 0)    -- red
			CPoints[2]:SetStatusBarColor(255, 0, 0)   -- red
			CPoints[3]:SetStatusBarColor(255, 255, 0)   -- yellow
			CPoints[4]:SetStatusBarColor(255, 255, 0)   -- yellow
			CPoints[5]:SetStatusBarColor(0, 255, 0)   -- green
		...
		if (C["unitframes"].unitcastbar) then			
			...
			if unit == "player" and C["unitframes"].cblatency == true then
				...
				castbar.safezone:SetVertexColor(0.90, 0.10, 0.10, 0.35)
	...
	if (unit == "pet") then
		...
		if (C["unitframes"].unitcastbar == true) then
			...
			castbar:SetPoint("TOPLEFT", power)
			castbar:SetPoint("BOTTOMRIGHT", power)
			castbarBG.shadow:Kill()
			
			castbar.time:Point("CENTER", castbar, "CENTER", 0, 0)
...
f:SetScript("OnEvent", function(self, event, addon)
	...
	if addon == "Tukui_Dps_Layout" then
		...
		if T.lowversion then
			...
			player:Point("TOP", UIParent, "BOTTOM", -310 , 260)
			target:Point("TOP", UIParent, "BOTTOM", 310, 260)
			tot:Point("TOPRIGHT", TukuiTarget, "BOTTOMRIGHT", 0, -7)
			pet:Point("TOPLEFT", TukuiPlayer, "BOTTOMLEFT", 0, -7)

			focus:Point("TOPRIGHT", TukuiTarget, "BOTTOMRIGHT", 0, -100)
		end
