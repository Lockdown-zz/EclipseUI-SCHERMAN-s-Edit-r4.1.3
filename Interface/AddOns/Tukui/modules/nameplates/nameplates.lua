...
local PlateBlacklist = {
	...
	["Fire Resistance Totem"] = false,
	["Flametongue Totem"] = false,
	["Frost Resistance Totem"] = false,
	["Healing Stream Totem"] = true,
	["Magma Totem"] = false,
	["Mana Spring Totem"] = true,
	["Nature Resistance Totem"] = false,
	["Searing Totem"] = false,
...
local function Colorize(frame)
	...
	if g+b == 0 then -- hostile
		r,g,b = 240/255, 130/255,  0/255
		frame.isFriendly = false
	elseif r+b == 0 then -- friendly npc
		r,g,b = .2, .4, .7
		frame.isFriendly = true
	elseif r+g > 1.95 then -- neutral
		r,g,b = 210/255, 210/255,  0/255
		frame.isFriendly = false
...
local function UpdateObjects(frame)
	...
	if C["nameplate"].showhealth == true then
		frame.hp.level:SetPoint("RIGHT", frame.hp, "RIGHT", -1, 0)
	else
...
local function SkinObjects(frame)
	...
	if C["nameplate"].showhealth == true then
		...
		hp.value:SetShadowColor(0, 0, 0, .1, 1)
		hp.value:SetPoint("CENTER", hp)
		hp.value:SetTextColor(1,1,1)
		hp.value:SetShadowOffset(1.55, -1.55)
	end
	...
	hp.name:SetShadowColor(0, 0, 0, .1, 1)
	hp.name:SetShadowOffset(1.55, 1.55)	
	hp.oldname = oldname
