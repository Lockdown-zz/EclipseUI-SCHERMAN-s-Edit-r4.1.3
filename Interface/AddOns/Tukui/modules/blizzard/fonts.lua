...
TukuiFonts:SetScript("OnEvent", function(self, event, addon)
	...
	-- Base fonts
	SetFont(GameTooltipHeader,                  PIXEL, 8, "OUTLINEMONOCHROME")
	...
	SetFont(SystemFont_Shadow_Med1,             PIXEL, 8, "OUTLINEMONOCHROME")
	...
	SetFont(Tooltip_Med,                        COMBAT, 8, "OUTLINEMONOCHROME")
	SetFont(Tooltip_Small,                      COMBAT, 8, "OUTLINEMONOCHROME")
