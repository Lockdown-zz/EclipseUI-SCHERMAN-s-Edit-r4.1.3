...
function LoseControl:new(unitId)
	...
	o.texture:SetTexCoord(.08, .92, .08, .92)
	...
	-- Begin Tukui Skinning
    o.bg = CreateFrame("Frame", nil, UIParent)
    o.bg:CreatePanel("Default", 1, 1, "BOTTOMLEFT", o.texture, "BOTTOMLEFT", -2, -2)
    o.bg:SetPoint("TOPRIGHT", o.texture, "TOPRIGHT", T.Scale(2), T.Scale(2))
    o.bg:SetBackdropBorderColor(unpack(C["media"].bordercolor))
    o.bg:SetBackdropColor(unpack(C["media"].backdropcolor))   
    o.bg:SetFrameLevel(0)
    o.bg:Hide()
    o:HookScript("OnShow", function(self)
        self.bg:Show()
    end)
    o:HookScript("OnHide", function(self)
        self.bg:Hide()
    end)
    -- End Tukui Skinning
