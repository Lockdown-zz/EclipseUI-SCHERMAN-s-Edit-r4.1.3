...
TukuiL.option_deathknight = "Enable the runebar for deathknight"
TukuiL.option_warlock = "Enable the soulshardbar for warlock"
TukuiL.option_shaman = "Enable the totembar for shaman"
TukuiL.option_druid = "Enable the solar-/lunarbar for druid"
